                        ...
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                <span class="clear">
                                    <span class="block m-t-xs" style="font-size:20px;">
                                        <strong class="font-bold">图书信息管理系统</strong>
                                    </span>
                                </span>
                        </a>
                    </div>
                    <div class="logo-element">图书信息管理系统
                    </div>
                </li>
            ...
            <ul class="nav navbar-top-links navbar-right">
                <li class="dropdown">
                    <a class="dropdown-toggle count-info" data-toggle="dropdown" href="#">
                        <span class="glyphicon glyphicon-user" aria-hidden="true"></span> <span class="label label-primary"></span>【<@shiro.principal type="com.bookmanage.base.entity.User" property="userCode"/>】
                    </a>
                        ...
                        <li>
                            <a href="${ctx!}/admin/logout">
                                <div>
                                    ...
                                    <span class="pull-right text-muted small"><@shiro.principal type="com.bookmanage.base.entity.User" property="userName"/></span>
                                </div>
                            </a>
                        </li>
                    </ul>
